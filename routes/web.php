...
use App\Http\Controllers\RegistrarDirectivoController; 
...
// Registro de directores de campañas
Route::controller(RegistrarDirectivoController::class)->group(function(){
    Route::get('/Actas_de_responsabilidad/Directivos', 'mostrarDirectivos')->name('mostrar_directivos');  // Mostrar todos los directivos
    Route::post('/Actas_de_responsabilidad/Directivos/Registro', 'registrar')->name('registrar_directivo');  // Registrar un nuevo directivo
});
...
//     Route::post('/Actas_de_responsabilidad/Aprobaciones/Enviar', 'enviarAprobacion')->name('enviar_aprobacion');
//     Route::get('/Actas_de_responsabilidad/Aprobaciones/Pendientes', 'verAprobacionesPendientes')->name('ver_aprobaciones');
//     Route::post('/Actas_de_responsabilidad/Aprobaciones/Aprobar/{id}', 'aprobarSolicitud')->name('aprobar_solicitud');
//     Route::post('/Actas_de_responsabilidad/Aprobaciones/Rechazar/{id}', 'rechazarSolicitud')->name('rechazar_solicitud');
// });
