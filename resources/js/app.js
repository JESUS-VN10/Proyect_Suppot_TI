...
import Aprovals from './components/Aprovals.vue';
import ModalDirectivos from './components/ModalDirectivos.vue';
...
app.component('modal-directivos', ModalDirectivos)
app.component('form-aprobaciones', Aprovals);
