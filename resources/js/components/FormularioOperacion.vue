  ...
  <div>
    <div id="operaciones m-2">
      ...
      <div class="xl:grid grid-cols-2 border-2 p-2 mt-5">
        <h1 class="text-2xl p-2 text-white col-span-2" style="background: linear-gradient(to right, #0E849C, #5A189A);">Datos basicos</h1>
      ...
      <ul class="grid grid-cols-2 justify-center align-around">
        <p :class="['col-span-2 text-2xl p-2 text-white']" style="background: linear-gradient(to right, #0E849C, #5A189A);">Definiciones</p>
      ...
      <div class="border-2 p-2 mt-5 grid grid-cols-1">
        ...
        <p :class="['text-2xl p-2 text-white']" style="background: linear-gradient(to right, #0E849C, #5A189A);">Activos relacionados:</p>
      ...
      <section class="grid grid-cols-1 border-2 p-2 mt-5">
        <p class="text-2xl p-2 text-white" style="background: linear-gradient(to right, #0E849C, #5A189A);">Observación:</p>
        ...
        <tr>
          <td :class="tabla">
            ...
            <select :class="[inputs,'p-3']" v-model="form_data.cargo_operacion" required>
              ...
              <option value="JEFE DE OPERACION">Jefe de Operacion TI</option>
    ...
    <div class="container-fluid" align="center">
      ...
      <p class="text-slate-800">Derechos reservados Americas BPS 2025</p>
    </div>
  </div>
</template>
