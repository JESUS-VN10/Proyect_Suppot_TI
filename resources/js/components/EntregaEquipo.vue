    ...
    <div class="card shadow-lg">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">        
            ...
            <section class="sm:grid grid-cols-3 mt-1 p-5 border-2 gap-8 justify-center items-center">
              <article class="text-2xl text-white col-span-3 p-2" style="background: linear-gradient(to right, #0E849C, #5A189A);">Datos de la entrega</article>
              <div class="row mb-3">
                <div class="col-md-4">
            ...
            <section class="sm:grid grid-cols-5 mt-5 p-2 border-2 gap-8 justify-center items-center ">
              <article class="text-2xl text-white col-span-5 p-2" style="background: linear-gradient(to right, #0E849C, #5A189A);">Datos del usuario</article>
      ...
      <label for="segundoMonitor" class="form-label">¿Tiene segundo monitor?</label>
        ...
        <div v-if="formData.segundoMonitor === 'Si'" class="mb-1">
          ...
          <section class="sm:border-2 mt-5 p-2 grid grid-cols-3 gap-8 justify-center items-center">
            <h4 class="text-2xl p-2 text-white col-span-3" style="background: linear-gradient(to right, #0E849C, #5A189A);">Periféricos</h4>
