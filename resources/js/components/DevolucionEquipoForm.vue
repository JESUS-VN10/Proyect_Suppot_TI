    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <section class="sm:grid grid-cols-3 mt-1 p-5 border-2 gap-8 justify-center items-center">
            <article class="text-2xl text-white col-span-3 p-2" style="background: linear-gradient(to right, #0E849C, #5A189A);">Datos del usuario</article>
            <article>
      ...
      <div class="border p-3 rounded mb-3">
        <section class="sm:border-2 mt-5 p-2 grid grid-cols-3 gap-8 justify-center items-center">
          <h4 class="text-2xl p-2 text-white col-span-3" style="background: linear-gradient(to right, #0E849C, #5A189A);">Detalles del Dispositivo</h4>
        ...
        <div class="row">
          <section class="grid grid-cols-3 p-2 mt-5 border-2 gap-8 ">
            <h3 class="text-white col-span-3 p-2 text-2xl" style="background: linear-gradient(to right, #0E849C, #5A189A);">Detalles del monitor</h3>
            <div class="mb-1">
        ...
        <div class="row">
          <section class="grid grid-cols-2 border-2 mt-5 p-2 gap-8 mb-8">
            <h4 class="text-white col-span-2 p-2 text-2xl" style="background: linear-gradient(to right, #0E849C, #5A189A);">Detalles de los perisfericos</h4>
            <div class="col-md-6 mb-3">
